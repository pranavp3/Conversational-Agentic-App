...
class ConversationalBot(param.Parameterized):
    def __init__(self, tools, **params):
        ...
        # New memory pattern - store chat history in memory
        ...
        ) | self.prompt | self.llm_with_tools | ToolsAgentOutputParser()

        self.agent_executor = AgentExecutor(agent=self.chain, tools=tools, verbose=False)
        
        # Wrap executor with message history
